                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list hide-phone">
                                <a class="nav-link dropdown-toggle arrow-none waves-effect text-white"
                                    ...
                                    aria-expanded="false">
                                    English <img src="<?= base_url() ?>/assets/images/flags/us_flag.jpg" class="ml-2"
                                        height="16" alt="" />
                                </a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img
                                                src="<?= base_url() ?>/assets/images/users/avatar-2.jpg" alt="user-img"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img
                                                src="<?= base_url() ?>/assets/images/users/avatar-3.jpg" alt="user-img"
                                                class="img-fluid rounded-circle" /> </div>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img
                                                src="<?= base_url() ?>/assets/images/users/avatar-4.jpg" alt="user-img"
                                                class="img-fluid rounded-circle" /> </div>
