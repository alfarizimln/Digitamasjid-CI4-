                                        ...
                                        <tbody>
                                            ...
                                            foreach ($kasmasuk as $val) {
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <input type="hidden" <?= $total += $val['kas_masuk']; ?>></input>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tr>
                                            <th colspan="4"><b>Total Kas Masuk</b></th>
                                            <th colspan="5"><b>
                                                    <?= $total ?>
                                                </b></th>
                                    </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <label><b>Jenis Kas</b></label>
                        <select class="form-control" name="jkas">
                            <option value="">=Pilih=</option>
                            <option value="Anak Yatim">Anak Yatim</option>
                            <option value="Sosial">Sosial</option>
                            <option value="Mesjid">Mesjid</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary"
                                            onclick="return pilih_donatur('<?= $d->iddonatur ?>','<?= $d->nama ?>')">
                                            Pilih
                                        </button>
                                    </td>
                                </tr>
